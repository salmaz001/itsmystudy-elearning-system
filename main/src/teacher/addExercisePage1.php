...
$numQues = $_POST["numQues"];
      ...
      echo "<script>alert('Error, please try again.');document.location='./addExercisePage.php'</script>";
  }
?>
    ...
    <section class="section dashboard">
      <div class="card ">
        <div class="card-body">
          ...
          <form class="row g-3" method="post" action="./backend/addExercise.php" onsubmit="return confirm('Are you sure you want to submit? You cannot edit the exercise once you have submit the form')" enctype="multipart/form-data">
            <h5>Questions</h5>
            <p>You need to choose the correct answer for each of the questions, minimum questions for 1 exercise are 3 questions, 3 choice options for each questions and you can add only one image for the question if necessary.</p>
            <div id="questions">
              <?php
for($i = 1; $i <= $numQues; $i++) {
  ?>
<div id="question<?php echo $i; ?>">
  ...
  <?php
            ...
            <div class="text-center">
              <button type="submit" name="submit_ex_final" class="btn btn-primary mt-0">Add Exercise</button>
            </div>
          </form>
