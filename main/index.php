            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="text-center mt-4" id="divmsg"></div>
                  ...
                  <form class="row g-3 needs-validation" novalidate method="POST" action="backend/login.php">
                    ...
                    <div class="col-12">
                      <p class="small mb-0 text-end"><a href="forgot-password.php">Forgot Password?</a></p>
                    </div>
                  </form>
